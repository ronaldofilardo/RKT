      ...
      <table className="w-full table-fixed">
        <thead>
          <tr className="text-[10px] text-gray-500 dark:text-gray-400 font-mono">
            <th scope="col" aria-label="Jogador" className="text-left py-1 pr-2 w-[80px] sm:w-[100px]"></th>
            ...
            <th scope="col" aria-label="Pontuação final" className="text-right px-2 py-1 font-semibold text-[10px] w-[28px] sm:w-[32px]"></th>
          </tr>
        </thead>
        <tbody>
          {/* Player 1 */}
