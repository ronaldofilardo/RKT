...
export function ScoringScreen({ data }: { data: ScoringViewData }) {
  ...
  const { abandonCurrentSession, openAceModal, handleAceDirect, handleServeErrorWithModal, handleServeErrorDirect, handleCancelSecondServe, handleServeCancel, handleRedo, handlePointFromCard, handleEditScore, handleEditScoreCancel, handleEditScoreRefreshFloor, handleSetupConfirm, handleUndo } = handlers;
