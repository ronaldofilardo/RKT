  ...
  return (
    <section className="bg-white rounded-xl shadow-sm border p-4">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <label htmlFor="match-date" className="block text-sm font-medium text-gray-700 mb-1">Data</label>
          <input
            id="match-date"
            type="date"
            value={date}
        ...
        <div>
          <label htmlFor="match-time" className="block text-sm font-medium text-gray-700 mb-1">Horário</label>
          <input
            id="match-time"
            type="time"
            value={time}
